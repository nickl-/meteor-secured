...
@font-face {
    ...
    src: url(/medias/web/font/eot/TheSerifOffice-TT7_.eot?#iefix) format('embedded-opentype'), url(/medias/web/font/woff/TheSerifOffice-TT7_.woff) format('woff');
    font-weight: 400;
    font-style: normal
}
...
@font-face {
    ...
    src: url(/medias/web/font/eot/fetteengschrift.eot?#iefix) format('embedded-opentype'), url(/medias/web/font/woff/fetteengschrift.woff) format('woff');
    font-weight: 400;
    font-style: normal
}
...
*+html .fb20x20, *+html .tw20x20, *+html .google20x20, *+html .mobile20x20, *+html .rss20x20 {
    display: inline
}
...
.bt_ouvrir:hover, .az:hover .bt_ouvrir, .conteneur_alterne_bt:hover .bt_ouvrir {
...
.bt_fermer:hover, .az:hover .bt_fermer, .conteneur_alterne_bt:hover .bt_fermer {
...
.ie .une_normale .liste_carre_999.liste_une .ie_pair {
    float: right;
    width: 48%
}

.ie .une_normale .liste_carre_999.liste_une .ie_impair {
    clear: left
}
...
.conteneur_autocompletion>ul {
    ...
    background: #f8f9fb;
    -webkit-box-shadow: 0 4px 8px -3px #444;
    -moz-box-shadow: 0 4px 8px -3px #444;
    -o-box-shadow: 0 4px 8px -3px #444;
    -ms-box-shadow: 0 4px 8px -3px #444;
    box-shadow: 0 4px 8px -3px #444;
...
.conteneur_onglets .onglet.courant {
    ...
    background: #fff;
    background: -moz-linear-gradient(top, #f1f5f8 0, #fff 100%);
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #f1f5f8), color-stop(100%, #fff));
    background: -webkit-linear-gradient(top, #f1f5f8 0, #fff 100%);
    background: -o-linear-gradient(top, #f1f5f8 0, #fff 100%);
    background: -ms-linear-gradient(top, #f1f5f8 0, #fff 100%);
    background: linear-gradient(top, #f1f5f8 0, #fff 100%);
...
.lien_img314x64.legislatives_2012_une {
    ...
    overflow: hidden;
    background: #2d3143;
    background: -moz-linear-gradient(top, #2d3143 0, #10141d 100%);
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #2d3143), color-stop(100%, #10141d));
    background: -webkit-linear-gradient(top, #2d3143 0, #10141d 100%);
    background: -o-linear-gradient(top, #2d3143 0, #10141d 100%);
    background: -ms-linear-gradient(top, #2d3143 0, #10141d 100%);
    background: linear-gradient(top, #2d3143 0, #10141d 100%)
}
...
.conteneur_popinbox {
    ...
    left: -145px;
    padding: 11px 0 0;
    -webkit-box-shadow: -1px 4px 3px -2px rgba(0, 11, 21, .5);
    -moz-box-shadow: -1px 4px 3px -2px rgba(0, 11, 21, .5);
    box-shadow: -1px 4px 3px -2px rgba(0, 11, 21, .5);
...
#surheader .services div {
    ...
    right: 0;
    top: 25px;
    -webkit-box-shadow: 0 2px 4px rgba(0, 11, 21, .5);
    -moz-box-shadow: 0 2px 4px rgba(0, 11, 21, .5);
    box-shadow: 0 2px 4px rgba(0, 11, 21, .5);
    width: 340px;
    z-index: 10;
    background: #fff
}
...
*+html .ombrelle .tt_rubrique_ombrelle, *+html .ombrelle.style .tt_rubrique_ombrelle {
    display: inline
}
...
.liste_reactions .bulle span {
    display: block;
    -webkit-box-shadow: 0 3px 2px 1px rgba(0, 11, 21, .2);
    -moz-box-shadow: 0 3px 2px 1px rgba(0, 11, 21, .2);
    box-shadow: 0 3px 2px 1px rgba(0, 11, 21, .2);
    border-radius: 4px;
    padding: 10px;
    background: #fff
}
...
.reaction_identifier .mini-login p {
    overflow: hidden;
    clear: both
}
...
#bandeau_bas .conteneur_en_continu {
    position: relative;
    margin: auto;
    width: 1000px;
    height: 25px;
...
#bandeau_bas .conteneur_lives .lives {
    -webkit-box-shadow: -3px 4px 15px -0 rgba(0, 11, 21, .5);
    -moz-box-shadow: -3px 4px 15px -0 rgba(0, 11, 21, .5);
    box-shadow: -3px 4px 15px -0 rgba(0, 11, 21, .5)
}
...
.conteneur_lives .live.petit .bandeau:hover {
    ...
    -webkit-transition: background-position .06s linear;
    -moz-transition: background-position .06s linear;
    -ms-transition: background-position .06s linear;
    -o-transition: background-position .06s linear;
...
#nav_ariane.international .ariane>a {
    color: #68b6db
}
...
body.access-pre .offers-hide-pre {
    display: none !important
}

body.access-ess .offers-hide-ess {
    display: none !important
}

body.access-bas .offers-hide-quo {
    display: none !important
}

body.access-pre .block-ad,
body.access-ess .block-ad {
    display: none !important
}
...
#header-liberation .header-base .sites-info-search ul.sites li.libe {
    width: 75px
}
...
#header-liberation .header-base .sites-info-search ul.sites li.next {
    width: 75px
}
...
#header-liberation .header-base .sites-info-search ul.sites li.ecrans {
    width: 65px
}
...
#header-liberation .header-base .sites-info-search ul.sites li.labo {
    width: 56px
}
...
#header-liberation .header-base .sites-info-search ul.sites li.boutique {
    width: 84px
}
...
#header-liberation .header-base .links ul li a {
    color: #808080
}
...
#header-liberation .header-base .nav .nav1 a:hover {
    text-decoration: none
}
...
#core-liberation .block .block-top h5 {
    font-size: 12px
}
...
#core-liberation .block-basic-curled {
    position: relative
}
...
#core-liberation .headrest span.right {
    float: right
}
...
#core-liberation .cartridge span.br {
    display: block
}
...
.w35unit .list-4-items li {
    width: 224px
}

.w29unit .list-4-items li {
    width: 182px
}

.w23unit .list-4-items li {
    width: 140px
}

.w35unit .list-3-items li {
    width: 308px
}

.w23unit .list-3-items li {
    width: 196px
}

.w23unit .list-2-items li {
    width: 308px
}
...
.ad-google .googleBanner .annonce:last-of-type {
    margin-bottom: 0
}
...
.site-liberation #header-liberation h1 {
    font-family: Verdana, Arial, Helvetica, sans-serif
}
...
#header-liberation .header-base .nav .on .nav2 {
    display: block
}
...
#header-liberation .header-base .nav .nav2 li a:hover {
    text-decoration: none
}

#header-liberation .header-base .nav .nav2 li.on {
    font-weight: 700
}
...
#header-liberation .header-base .nav .nav2 li:last-of-type a span {
    display: none
}

#header-liberation .header-base .nav-no-js>li:hover .nav2 {
    display: block !important
}

#header-liberation .header-base .nav-no-js:hover .on .nav2 {
    display: none
}

#header-liberation .header-simple {
    margin: 0 41px
}
...
.site-liberation #footer-liberation h3 {
    font-family: Verdana, Arial, Helvetica, sans-serif
}

#footer-liberation .footer-base {
    margin: 0 10px
}
...
#footer-liberation .services ul:last-of-type li {
    padding: 0 0 0 14px
}

#footer-liberation .references {
    clear: both
}
...
#footer-liberation .references ul:last-child {
    padding-bottom: 0
}
...
#footer-liberation .references ul li.first {
    padding-left: 0
}

#core-liberation .text h2,
#core-liberation .text h3 {
    margin-bottom: 14px
}

#core-liberation .text sub,
#core-liberation .text sup {
    line-height: 10px
}
...
#core-liberation .new_comment_form_wrapper {
    position: relative
}
...
#core-liberation .form-monlibe-unlogged {
    position: relative
}
...
#core-liberation .form-monlibe .monlibe-edit-profile p {
    clear: both
}

#core-liberation .form-monlibe .monlibe-edit-profile .btn-monlibe {
    margin-top: 30px
}

#core-liberation .block-comments .form-monlibe {
    border-top: 0
}

#core-liberation .block-comments .form-monlibe input[type=text],
#core-liberation .block-comments .form-monlibe textarea {
    width: 98%
}

#core-liberation .form-contacts {
    width: 380px
}

#core-liberation .form-contacts p {
    margin-bottom: 10px
}

#core-liberation .form-contacts p a {
    font-weight: 700
}
...
#core-liberation .form-contacts p input[type=text] {
    width: 372px
}
...
#core-liberation .form-contacts p select {
    width: 300px
}
...
#core-liberation .form-https p:last-child {
    margin-bottom: 0
}
...
#core-liberation .col-contextual ul li {
    margin-bottom: 5px
}
...
#core-liberation ul.list-links li:last-child {
    margin-bottom: 0
}
...
#core-liberation ul.list-forums li h4 span {
    padding-left: 5px
}

#core-liberation ul.list-forums span {
    font-weight: 400
}
...
#core-liberation ul.list-items li p {
    margin-left: 98px
}
...
#core-liberation ul.list-items span {
    padding: 0 5px 0 0
}
...
#core-liberation ul.list-items li.full p {
    margin-left: 0
}

#core-liberation ul.list-items li.half img.visual {
    width: 130px
}

#core-liberation ul.list-items li.full h5,
#core-liberation ul.list-items li.half h4,
#core-liberation ul.list-items li.half p {
    margin-left: 140px
}
...
#core-liberation ul.list-items li.arround p {
    margin-left: 0
}
...
#core-liberation ul.list-items li.chat h5 {
    margin-bottom: 5px
}

#core-liberation ul.list-items-mosts li {
    margin-bottom: 5px
}
...
#core-liberation ul.list-rss-stream {
    list-style: none
}
...
#core-liberation ul.list-rss-stream li img.xml {
    margin-top: 1px
}

#core-liberation ul.list-rss-stream li img.google {
    margin-top: 0
}

#core-liberation ul.list-rss-stream li img.netvibes {
    margin-top: 0
}
...
#core-liberation ul.list-call-items li {
    margin-bottom: 15px
}

#core-liberation ul.list-call-items li h2 {
    margin-bottom: 5px
}

#core-liberation ul.list-call-items.sheet li h2 {
    font-size: 13px
}
...
#core-liberation ul.list-labo-meetings li:last-child {
    border-bottom: 0
}
...
#core-liberation .list-man-of-day h2 span {
    font-size: 39px
}
...
#core-liberation .block .block-bottom .pager {
    padding: 6px 0 0
}
...
.block-solid-c1 .block-bottom {
    border-top: 1px solid
}

.block-solid-c1 .block-bottom a.lnk-readmore {
    font-size: 11px
}
...
.w11unit .col-contextual .block-ad iframe {
    max-width: 308px
}
...
.col-contextual>.block:last-child {
    margin-bottom: 28px
}
...
.col-contextual .block .block-bottom a.lnk-readmore {
    font-size: 11px
}
...
.col-contextual .headrest {
    margin-bottom: 3px
}

.col-contextual .block .headrest {
    margin-bottom: 0
}

.col-contextual .block-nobg {
    padding: 10px 0
}

.col-contextual .block-solid-c2 .block-top {
...
.col-part .block .follow-libe .nv-rss a.rss {
    background: url(http://s0.libe.com/libe/img/common/ico-rss.jpg?e5d7b4c9c034) no-repeat 0 1px
}
...
.col-part .block .follow-libe img.visual {
    margin-top: 7px
}
...
.block-basic-rounded .block-content {
    padding: 14px
}

#core-liberation .block-item {
    margin-bottom: 28px
}
...
#core-liberation .block-item .object-header h1 {
    margin-bottom: 14px
}

#core-liberation .block-item .object-header h5 {
    margin-bottom: 14px
}

#core-liberation .block-item .object-picture .visual100 {
    margin-bottom: 4px
}
...
#core-liberation .block-item .object-media {
    margin-bottom: 14px
}

#core-liberation .block-item .object-content div.author {
    margin-bottom: 15px
}
...
.site-liberation .block-item .object-content a {
    text-decoration: underline
}

#core-liberation .w17unit .block-item .object-content img {
    max-width: 476px
}
...
#core-liberation .selected-comments .comment_reply_links {
    display: none
}
...
#core-liberation .block-item-locked .block-content {
    padding: 20px 0 10px
}
...
#core-liberation .block-item-locked a {
    text-decoration: none
}
...
#core-liberation .block-item-locked p {
    margin-left: 270px
}
...
#core-liberation .block-item-locked h3 .euro {
    font-size: 19px
}
...
#core-liberation .block-item-locked .btn-zoneabo a:hover {
    text-decoration: underline
}
...
#core-liberation .block-item-read-more .block-content {
    clear: both
}
...
#core-liberation .block-item-read-more .block-content .mini-tpl h5 {
    margin-bottom: 7px
}

#core-liberation .block-item-read-more .block-content .mini-tpl .visual {
    margin-right: 14px
}
...
#core-liberation .block-comments .block-content .block-comments-tree {
    overflow: hidden
}

#core-liberation .block-comments .block-content .comment {
    border-left: 1px solid
}

#core-liberation .block-comments .block-content .comment_level_0 .comment {
    margin-left: 14px
}
...
#core-liberation .block-comments .comment_level_0:first-of-type {
    margin-top: 0
}
...
#core-liberation .block-comments .block-content .comment_draft>.comment_outer {
    background-image: url(http://s0.libe.com/libe/img/common/bg-comment-draft.png?4158f727c626)
}

#core-liberation .block-comments .block-content .comment_collapsed>.comment_content>*,
#core-liberation .block-comments .block-content .comment_collapsed>.visual {
    display: none
}

#core-liberation .block-comments .block-content .comment_expanded>.comment_content>*,
#core-liberation .block-comments .block-content .comment_expanded>.visual {
    display: block
}
...
#core-liberation .block-comments .block-content .meta .details a.profile {
    display: none
}

#core-liberation .block-comments .block-content .comment_hover .meta .details a.profile {
    display: block
}
...
#core-liberation .block-comments .block-content .comment_reply_links .comment_flag:hover .icon {
    background-position: -33px -18px
}

#core-liberation .block-comments .block-content .comment_reply_links .comment_flag:hover {
    text-decoration: none
}
...
#core-liberation .block-comments .block-content .comment_reply_links .comment_reply:hover {
    text-decoration: none
}
...
#core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .note {
    padding-right: 41px
}
...
#core-liberation .block-comments .comment_cutoff {
    display: block
}

#core-liberation .block-usercomments .comment_replies {
    display: block
}

#core-liberation .block-usercomments .noreplies {
    display: none
}

#core-liberation .block-comments .headrest-community h3 a:hover {
    text-decoration: none
}
...
.comment_hover .comment_god_actions {
    display: block
}

.comment_god_actions ul,
.comment_god_actions li,
.comment_god_actions form {
    display: inline-block
}
...
#bar-liberation .god a.godenter {
    background: url(http://s0.libe.com/libe/img/common/icon_godenter.png?9ffa63824b5c) no-repeat center center #fff
}

#bar-liberation .god a.godquit {
    background: url(http://s0.libe.com/libe/img/common/icon_godquit.png?a59104f30cfb) no-repeat center center #000
}

#bar-liberation .god a.godquit:hover {
    background: url(http://s0.libe.com/libe/img/common/icon_godenter.png?9ffa63824b5c) no-repeat center center yellow
}

#bar-liberation .god a.jumptoadmin {
    background: url(http://s0.libe.com/back/img/icon_home.png?c1de55b52ccc) no-repeat center center #fff
}

#bar-liberation .god a.jumptoedit {
    background: url(http://s0.libe.com/back/img/icon_changelink.png?4a31d309d5db) no-repeat center center #fff
}
...
#core-liberation .block-partnership .block-content p {
...
#core-liberation .block-pager-labo {
    padding: 14px
}

#core-liberation .block-pager-labo .block-top,
#core-liberation .block-pager-labo .block-content {
    margin-bottom: 14px
}

#core-liberation .block-pager-labo .list li {
    margin-bottom: 0
}
...
#core-liberation .block-pager-labo .list h5 {
    margin-bottom: 7px
}

#core-liberation .block-pager-labo .block-bottom {
    border-top: 1px solid
}

#core-liberation .block-pager-labo .block-bottom .pager {
    padding-top: 13px
}

#core-liberation .block-pager-labo .block-bottom .right {
    padding-top: 7px
}
...
#core-liberation .col .block-pager-labo .list li.new-line {
    margin-left: 0
}

#core-liberation .block-podcast .block-content p.note {
    font-size: 10px
}
...
#core-liberation .block-podcast .block-content p {
    margin-bottom: 10px
}
...
#core-liberation .block-benefits .block-content ul li {
    margin-bottom: 0
}
...
#core-liberation .block-benefits .block-content .text-benefits li p {
    margin-left: 126px
}

#core-liberation .col-contextual .block-label {
    padding: 0
}

#core-liberation .col-contextual .block-label .block-content {
    padding: 0
}
...
#core-liberation .block-np .railway .box h5 {
    display: none
}
...
#core-liberation .block-np .block-content .railway ul li.p-r {
    margin-right: 4px
}
...
#core-liberation .block-np .pager {
    margin-bottom: 7px
}
...
#core-liberation .block-np .from ul li {
    margin-bottom: 14px
}
...
#core-liberation .block-np .from ul li.l img.visual {
    float: right
}
...
.col-contextual .block-subscribe-newsletter p {
...
.col-contextual .block-subscribe-newsletter input[type=submit] {
    float: right
}
...
#core-liberation .col-contextual .block-promo .block-content p {
    margin: 0 0 10px 154px
}
...
#core-liberation .block-all-forums .block-content .forums-most {
    margin-bottom: 28px
}

#core-liberation .block-all-forums .block-top .filters .on {
    font-weight: 700
}
...
#core-liberation .block-all-forums .forum:first-child {
    padding-top: 0
}
...
#core-liberation .block-all-forums .forum h5.title .right {
    font-weight: 400
}
...
#core-liberation .block-all-forums .forum p.subtitle {
    margin-left: 70px
}
...
#core-liberation .block-all-forums .forum span.infos a {
    font-weight: 700
}
...
#core-liberation .block-all-forums table th.subject {
    width: 60%
}

#core-liberation .block-all-forums table .subject {
    text-align: left
}
...
#core-liberation .block-all-forums table .ft-c {
    text-align: center
}

#core-liberation .block-all-forums table th,
#core-liberation .block-all-forums table td {
    padding: 4px 0 6px
}

#core-liberation .block-all-blogs {
    margin-bottom: 28px
}

#core-liberation .block-all-blogs .block-content .headrest {
    border-bottom: 1px dotted #ddd
}

#core-liberation .block-all-blogs .headrest h4 {
    text-transform: uppercase
}
...
#core-liberation .block-all-blogs .block-content .list .mini-tpl {
    border-bottom: 0
}

#core-liberation .block-all-blogs .block-content .list li {
    clear: none
}

#core-liberation .block-all-blogs .block-content .list li.new-line {
    clear: both
}

#core-liberation .block-all-blogs .block-content .list .blog h5 .icon {
    display: none
}
...
#core-liberation .block-all-blogs .block-content .list .blog-libe {
    padding-top: 3px
}
...
#core-liberation .block-all-blogs .block-content .list .blog-libe img.visual {
    margin-top: 0
}
...
#core-liberation .block-search-head form input[type=submit]:hover {
    background-image: url(http://s0.libe.com/libe/img/common/bg-search-formsubmit-on.png?21388ca68b89)
}

#core-liberation .block-search-results form input[type=submit]:active {
    background-image: url(http://s0.libe.com/libe/img/common/bg-search-formsubmit-active.png?16bd2d8fbc96)
}
...
#core-liberation .block-search-results .pagination a {
    background-color: #fff
}
...
#core-liberation .block-search-head {
    margin-bottom: 20px
}
...
#core-liberation .block-search-head .basic {
    padding-bottom: 7px
}

#core-liberation .block-search-head .basic label {
    display: none
}

#core-liberation .block-search-head .basic input[type=text] {
    width: 521px
}
...
#core-liberation .block-search-head .displayed .note a.displayer {
    background-image: url(http://s0.libe.com/libe/img/common/bg-search-up.png?6f25843d1bc2)
}
...
#core-liberation .block-search-head .advanced .searchform select {
    font-size: 10px
}
...
#core-liberation .block-search-head .advanced .searchform .period label {
    padding-right: 4px
}

#core-liberation .block-search-head .advanced .searchform .period ul li {
    display: inline
}
...
#core-liberation .block-search-head .advanced .searchform .between span {
    padding-right: 5px
}

#core-liberation .block-search-head .advanced .searchform .source ul,
#core-liberation .block-search-head .advanced .searchform .source ul li {
    display: inline
}
...
#core-liberation .block-search-head .advanced .searchform input[type=submit] {
    margin: 10px 0 0 165px
}

#core-liberation .block-search-head .results {
    margin-bottom: 15px
}

#core-liberation .block-search-head .results p {
    margin-bottom: 15px
}
...
#core-liberation .block-search-results .block-top {
    margin-bottom: 0
}
...
#core-liberation .block-search-results .tpl-search-results {
    margin-bottom: 0
}

#core-liberation .block-search-results .tpl-search-results .object-content {
    padding-top: 14px
}

#core-liberation .block-search-results .tpl-search-results .object-picture {
    top: 14px
}

#core-liberation .block-search-results .tpl-search-results .folder .object-content,
#core-liberation .block-search-results .tpl-search-results .emission .object-content {
    min-height: 53px
}

#core-liberation .block-search-results .tpl-search-results .article .object-content {
    min-height: 116px
}

#core-liberation .block-search-results .tpl-search-results .category .object-content {
    margin-right: 0
}
...
#core-liberation .block-search-results .block-content {
    margin-bottom: 15px
}
...
#core-liberation .block-search-results .block-content h4 span {
    text-transform: uppercase
}
...
#core-liberation .block-search-results .block-content h4 a:hover span {
    text-decoration: underline
}
...
#core-liberation .block-search-results .block-content .article .object-picture img {
    height: 116px
}

#core-liberation .block-search-results .block-content .object-picture .np {
    position: relative
}
...
#core-liberation .headrest .folder {
    background: url(http://s0.libe.com/libe/img/common/bg-headrest-triangle.png?589ad9ce9011) no-repeat right center
}
...
#core-liberation .headrest .folder p {
    margin-left: 14px
}
...
#core-liberation .headrest-community {
    margin-bottom: 14px
}
...
#core-liberation .cartridge .share {
    padding: 0 5px
}
...
#core-liberation .cartridge .share li a.twitter {
    margin-top: 7px
}

#core-liberation .cartridge .share li a.facebook {
    margin-top: 6px
}

#core-liberation .cartridge .share li a.mail {
    margin-top: 8px
}

#core-liberation .cartridge .share li a.star {
    margin-top: 4px
}

#core-liberation .cartridge .btn-comment,
#core-liberation .cartridge .btn-back {
    text-align: center
}
...
#core-liberation .cartridge a.btn-back:hover {
    text-decoration: none
}

#core-liberation .cartridge a.btn-comment-disabled {
    background: transparent url(http://s0.libe.com/libe/img/common/bg-btn-comment.png?593ec6d1f747)
}

#core-liberation .cartridge a.btn-comment-disabled:hover {
    cursor: default
}

#core-liberation .cartridge .options-tab {
    position: relative
}
...
#core-liberation .cartridge .options-tab-content a {
    display: block
}
...
#core-liberation .cartridge a.options-tab-label:hover {
    text-decoration: none
}
...
#core-liberation .cartridge-basic-rounded .segment {
...
#core-liberation .cartridge-basic-rounded .options-tab {
    border-left: 0
}

#core-liberation .cartridge-basic-bubble {
    height: 30px
}
...
#core-liberation .w23unit .cartridge-basic-bubble .segment {
    margin-right: 29px
}

#core-liberation .w17unit .cartridge-basic-bubble .segment {
    margin-right: 47px
}

#core-liberation .w23unit .cartridge-basic-bubble .text,
#core-liberation .w17unit .cartridge-basic-bubble .text {
    margin-right: 0
}
...
#core-liberation .cartridge-basic-bubble .share {
    width: 115px
}

#core-liberation .cartridge-basic-bubble .btn-back {
    width: 150px
}

#core-liberation .cartridge-basic-bubble .text {
    width: 150px
}

#core-liberation .block-item .cartridge-basic-bubble .btn-comment {
    width: 100px
}
...
form .btn-rounded-degraded input[type=submit]:focus {
    text-decoration: none
}
...
#core-liberation .block .pager ul {
    float: left
}
...
#core-liberation .block .pager ul.circle li a.on {
    background-image: url(http://s0.libe.com/libe/img/common/btn-circle-on.gif?c66d45940adc)
}

#core-liberation .block .pager ul.circle li a.prev {
    background-image: url(http://s0.libe.com/libe/img/common/bg-search-pagination-prev.png?0ae4b5772718)
}

#core-liberation .block .pager ul.circle li a.next {
    background-image: url(http://s0.libe.com/libe/img/common/bg-search-pagination-next.png?363861606f55)
}
...
#core-liberation .bg-sprites-icons a.twitter:hover {
...
#core-liberation .bg-sprites-icons a.facebook:hover {
...
#core-liberation .bg-sprites-icons a.mail:hover {
...
#core-liberation .bg-sprites-icons a.star:hover {
...
#core-liberation .toolbox>li:first-child {
    margin-left: 0
}

#core-liberation .toolbox li.right {
    margin-right: 0
}
...
.site-liberation .toolbox .twitter {
    text-decoration: none
}

.site-liberation .toolbox li a span {
    display: block
}
...
.site-liberation .toolbox li.abo-1-euro span.ft-c {
    margin-top: 1px
}
...
body.init-bar-is-closed #bar-liberation {
    height: 15px
}
...
#bar-liberation .content .activities-stream .list .more {
    display: none
}

#bar-liberation .content .activities-stream .list .text,
#bar-liberation .content .activities-stream .list p {
    display: inline
}
...
#bar-liberation .content a.displayer:hover .arrow {
    background: url(http://s0.libe.com/libe/img/common/_sprites_header/triangle_ferme_grey.png?a9a52344ba82) no-repeat 0 0
}

#bar-liberation .content a.displayer .arrow-displayed {
    background: url(http://s0.libe.com/libe/img/common/_sprites_header/triangle_ouvert.png?c782eb482038) no-repeat 1px 1px
}

#bar-liberation .content a.displayer:hover .arrow-displayed {
    background: url(http://s0.libe.com/libe/img/common/_sprites_header/triangle_ouvert.png?c782eb482038) no-repeat 1px 1px
}
...
#bar-liberation .content ul.list li a:hover {
    text-decoration: underline
}

#bar-liberation .content ul.list li:last-of-type {
    border-bottom: 0
}

#bar-liberation .content ul.list li:first-of-type {
    padding-right: 30px
}
...
#bar-liberation .content .login a.subscribe:hover {
    text-decoration: none
}
...
#bar-liberation #login-box-content form .btn-basic {
    margin: 10px 0
}
...
#bar-liberation #login-box-content p.forgot-password a:hover {
    text-decoration: underline
}
...
#bar-liberation #personal-options-content ul.subscription {
    width: 149px
}
...
#bar-liberation #personal-options-content ul li a:hover {
    text-decoration: underline
}

#bar-liberation #personal-options-content ul li {
    padding: 0 10px 4px
}

#bar-liberation #personal-options-content ul li.spacer {
    height: 5px
}

#bar-liberation #personal-options-content ul li.indent {
    padding-left: 20px
}
...
#bar-liberation .content .mail-box a:hover span.letter {
...
#bar-liberation .content .activities-stream a:hover {
    text-decoration: underline
}
...
#bar-liberation .content .other .ad-1 {
    padding: 6px 10px
}
...
#page-mailfriend .content input[type=text] {
    width: 275px
}
...
#page-paywall .content .arguments .arg .visual1 {
    height: 71px
}

#page-paywall .content .arguments .arg .visual2 {
    height: 76px
}
...
#page-paywall .content .arguments .arg .price strong .decimals {
    font-size: 20px
}
...
#page-paywall .content .arguments .arg .price .total {
    font-size: 10px
}

#page-paywall .content .arguments .arg .price .btn-rounded-degraded {
    margin-top: 10px
}
...
#page-paywall .content .banner-degraded a {
    font-weight: 700
}

#page-paywall .content .form-login {
    padding: 20px 20px 0
}

#page-paywall .content .form-login p {
    margin-bottom: 10px
}
...
#page-paywall .content .form-login form p input[type=password]:focus {
    border: 1px solid
}
...
.site-liberation h5 .theme {
    text-transform: uppercase
}

.site-liberation h5 a.theme:hover,
.site-liberation a:hover h5 .theme {
    text-decoration: none
}
...
.site-liberation p.subtitle {
    line-height: 16px
}

.site-liberation .text p {
    margin-bottom: 7px
}

.site-liberation .text-item img.i_orig {
    margin-bottom: 14px
}
...
.site-liberation .text-item p.essential a {
    color: #818181
}

.site-liberation .text-item p.essential a:hover {
    color: #E20000
}
...
.site-liberation .author {
    font-size: 10px
}

.site-liberation .author strong {
    text-transform: uppercase
}
...
.site-liberation .block-call-items .block-top {
    margin-bottom: 10px
}
...
.site-liberation .block-call-items .mini-tpl .right {
    float: right
}
...
.site-liberation .block-call-items .mini-tpl h2 {
    margin-bottom: 14px
}
...
.site-liberation .block-call-items .mini-tpl h5 .date {
    text-transform: none
}
...
.site-liberation .block-call-items .mini-tpl .theme {
    text-transform: uppercase
}
...
.site-liberation .block-call-items .mini-tpl .others {
    margin-bottom: 14px
}

.site-liberation .block-call-items .mini-tpl .others .list-linked-items {
    clear: right
}
...
.site-liberation .block-call-items .mini-tpl .subtitle .slug {
    font-weight: 700
}
...
.site-liberation .block-call-items .mini-tpl .whosaid h5 .theme {
    font-size: 14px
}

.site-liberation .block-call-items .mini-tpl .whosaid h5 a.theme:hover {
    text-decoration: underline
}
...
.site-liberation .block-call-items .mini-tpl .whosaid .answer {
    margin-top: 10px
}

.site-liberation .block-call-items .mini-tpl .whosaid .answer h4 {
    margin-bottom: 10px
}
...
.site-liberation .block-call-items .mini-tpl .chat .contribute {
    display: block
}
...
.site-liberation .block-call-items .mini-tpl .chat .contribute form {
    padding: 14px 0
}

.site-liberation .block-call-items .mini-tpl .chat .contribute form fieldset {
    border: 0
}
...
.site-liberation .block-call-items .mini-tpl .chat .contribute form fieldset input[type=submit] {
    float: right
}

.site-liberation .block-call-items .mini-tpl .chat .contribute .btn {
    float: left
}

.site-liberation .w17unit .block-call-items .mini-tpl .others,
.site-liberation .w17unit .block-call-items .mini-tpl .others ul.list-linked-items {
    clear: both
}
...
.site-liberation .w14unit .block-call-items .mini-tpl .others ul.list-linked-items {
    clear: both
}
...
.site-liberation .block-call-items .tpl-flash-news-29unit .big {
    margin-right: 28px
}

.site-liberation .block-call-items .tpl-flash-news-29unit .item .clear {
    clear: right
}

.site-liberation .block-call-items .tpl-flash-news-29unit .others {
    clear: none
}
...
.site-liberation .block-call-items .tpl-breaking-news h3 {
    font-weight: 700
}
...
.site-liberation .block-call-items .tpl-spotlight {
    padding-bottom: 14px
}
...
.site-liberation .block-call-items .tpl-spotlight .lnk-comments {
    margin-top: 0
}
...
.site-liberation .block-call-items .tpl-labo:first-of-type {
    padding-top: 0
}

.site-liberation .block-call-items .tpl-labo h2 {
    margin-bottom: 7px
}

.site-liberation .block-call-items .tpl-labo p.subtitle {
    margin-bottom: 14px
}
...
.site-liberation .block-call-items .tpl-labo .subscribe p.infos {
    font-weight: 700
}

.site-liberation .block-call-items .tpl-labo .subscribe p.infos span {
    text-transform: uppercase
}

.site-liberation .block-call-items .tpl-labo .subscribe p .toggle {
    font-size: 10px
}
...
.site-liberation .block-call-items .tpl-labo .episode .pager ul {
    margin-top: 7px
}
...
.site-liberation .block-call-items .tpl-labo-spotlight:first-of-type {
    padding-top: 8px
}

.site-liberation .block-call-items .tpl-labo-spotlight .subscribe {
    margin-bottom: 5px
}
...
.site-liberation .block-call-items .tpl-labo-podcast:first-of-type {
    padding-top: 0
}

.site-liberation .block-call-items .tpl-labo-podcast .emission h2 {
    margin-bottom: 3px
}

.site-liberation .block-call-items .tpl-labo-podcast .emission p.subtitle {
    margin-bottom: 10px
}
...
.site-liberation .block-call-items .tpl-labo-podcast .emission .subscribe {
    clear: both
}

.site-liberation .block-call-items .tpl-labo-podcast .emission .subscribe p {
    color: #e20000
}
...
.site-liberation .block-call-items .tpl-labo-podcast .emission .subscribe p.infos span {
    text-transform: uppercase
}

.site-liberation .block-call-items .tpl-labo-podcast .emission .subscribe .sb-podcasts {
    margin-top: 10px
}
...
.site-liberation .block-call-items .tpl-labo-podcast .episode .pager ul {
    margin-top: 5px
}
...
.site-liberation .block-call-items .tpl-search-results .item {
    margin: 0
}
...
.site-liberation .block-call-items .tpl-search-results:last-of-type .object-content {
    border-bottom: 0
}
...
.site-liberation .block-call-items .tpl-search-results h4 span {
    text-transform: uppercase
}
...
.site-liberation .block-call-items .tpl-search-results h4 a:hover span {
    text-decoration: underline
}

.site-liberation .block-call-items .tpl-search-results p {
    margin-top: 10px
}
...
.site-liberation .block-call-items .tpl-search-results .folder-on-demand .object-content {
    margin-right: 160px
}
...
.site-liberation .block-call-items .tpl-search-results .object-picture .np {
    position: relative
}
...
.site-liberation .block-call-items .tpl-no-border {
    border-bottom: 0
}
...
.site-liberation .block-call-items .tpl-visual-square-left .subtitle {
    margin-left: 98px
}
...
.site-liberation .block-call-items .tpl-visual-square-left .chat .contribute {
    clear: both
}
...
.site-liberation .block-call-items .tpl-visual-square-left-arround p.subtitle {
    font-size: 11px
}

body.barry-white {
    background: #f8f8f8 url(http://s0.libe.com/libe/img/common/bg-body-fff.gif?62ad83bcadf5) repeat-y center 0
}
...
.site-liberation .ad-google .googleBanner .annonce:hover {
    background: #fff
}

.site-liberation .ad-google .googleBanner .annonce .titre {
    color: #e20000
}

.site-liberation .ad-google .googleBanner .annonce .texte {
    color: #222
}

.site-liberation .ad-google .googleBanner .annonce .url {
    color: #ccc
}
...
.site-liberation a.lnk-readmore {
    color: #e20000
}
...
.cat-ecrans .bg-c {
    background-color: #1d9b9a
}

.cat-ecrans .ft-c {
    color: #1d9b9a !important
}

.cat-mode .bg-c {
    background-color: #944d93
}

.cat-mode .ft-c {
    color: #944d93 !important
}
...
.site-liberation .hot-topics .event {
    background: #b1b1b1
}

.site-liberation #footer-liberation .hot-topics .event a {
    color: #fff
}
...
#header-liberation .header-base .nav .cat-laune .nav1 a:hover {
    background-color: #e20000
}

#header-liberation .header-base .nav .cat-labo .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-labo:hover .nav1 a,
#header-liberation .header-base .nav .cat-labo .nav1 a:hover {
    background-color: #006a96
}

#header-liberation .header-base .nav .cat-culture .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-culture:hover .nav1 a,
#header-liberation .header-base .nav .cat-culture .nav1 a:hover {
    background-color: #e52d83
}

#header-liberation .header-base .nav .cat-rebonds .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-rebonds:hover .nav1 a,
#header-liberation .header-base .nav .cat-rebonds .nav1 a:hover {
    background-color: #00b3e2
}

#header-liberation .header-base .nav .cat-ecrans .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-ecrans:hover .nav1 a,
#header-liberation .header-base .nav .cat-ecrans .nav1 a:hover {
    background-color: #1d9b9a
}

#header-liberation .header-base .nav .cat-mode .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-mode:hover .nav1 a,
#header-liberation .header-base .nav .cat-mode .nav1 a:hover {
    background-color: #944d93
}

#header-liberation .header-base .nav .cat-blogs .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-blogs:hover .nav1 a,
#header-liberation .header-base .nav .cat-blogs .nav1 a:hover {
    background-color: #324c99
}

#header-liberation .header-base .nav .cat-voyages .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-voyages:hover .nav1 a,
#header-liberation .header-base .nav .cat-voyages .nav1 a:hover {
    background-color: #7baf1f
}

#header-liberation .header-base .nav .cat-regions .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-regions:hover .nav1 a,
#header-liberation .header-base .nav .cat-regions .nav1 a:hover {
    background-color: #f2a787
}

#header-liberation .header-base .nav .cat-monlibe .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-monlibe:hover .nav1 a,
#header-liberation .header-base .nav .cat-monlibe .nav1 a:hover {
    background-color: #fe9900
}

#header-liberation .header-base .nav .cat-zoneabo .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-zoneabo:hover .nav1 a,
#header-liberation .header-base .nav .cat-zoneabo .nav1 a:hover {
    background-color: #a00
}

#header-liberation .header-base .nav .cat-food .nav1 .on a,
#header-liberation .header-base .nav-no-js .cat-food:hover .nav1 a,
#header-liberation .header-base .nav .cat-food .nav1 a:hover {
    background-color: #000
}

#header-liberation .header-base .nav .cat-laune .nav2 {
    border-top: 3px solid #e20000
}

#header-liberation .header-base .nav .cat-labo .nav2 {
    border-top: 3px solid #006a96
}

#header-liberation .header-base .nav .cat-culture .nav2 {
    border-top: 3px solid #e52d83
}

#header-liberation .header-base .nav .cat-rebonds .nav2 {
    border-top: 3px solid #00b3e2
}

#header-liberation .header-base .nav .cat-ecrans .nav2 {
    border-top: 3px solid #1d9b9a
}

#header-liberation .header-base .nav .cat-mode .nav2 {
    border-top: 3px solid #944d93
}

#header-liberation .header-base .nav .cat-blogs .nav2 {
    border-top: 3px solid #324c99
}

#header-liberation .header-base .nav .cat-voyages .nav2 {
    border-top: 3px solid #7baf1f
}

#header-liberation .header-base .nav .cat-regions .nav2 {
    border-top: 3px solid #f2a787
}

#header-liberation .header-base .nav .cat-monlibe .nav2 {
    border-top: 3px solid #fe9900
}

#header-liberation .header-base .nav .cat-zoneabo .nav2 {
    border-top: 3px solid #a00
}

#header-liberation .header-base .nav .cat-food .nav2 {
    border-top: 3px solid #000
}

#header-liberation .header-base .nav .cat-laune .nav2 a:hover,
#header-liberation .header-base .nav .cat-laune .nav2 .on {
    color: #e20000
}

#header-liberation .header-base .nav .cat-labo .nav2 a:hover,
#header-liberation .header-base .nav .cat-labo .nav2 .on {
    color: #006a96
}

#header-liberation .header-base .nav .cat-culture .nav2 a:hover,
#header-liberation .header-base .nav .cat-culture .nav2 .on {
    color: #e52d83
}

#header-liberation .header-base .nav .cat-rebonds .nav2 a:hover,
#header-liberation .header-base .nav .cat-rebonds .nav2 .on {
    color: #00b3e2
}

#header-liberation .header-base .nav .cat-ecrans .nav2 a:hover,
#header-liberation .header-base .nav .cat-ecrans .nav2 .on {
    color: #1d9b9a
}

#header-liberation .header-base .nav .cat-mode .nav2 a:hover,
#header-liberation .header-base .nav .cat-mode .nav2 .on {
    color: #944d93
}

#header-liberation .header-base .nav .cat-blogs .nav2 a:hover,
#header-liberation .header-base .nav .cat-blogs .nav2 .on {
    color: #324c99
}

#header-liberation .header-base .nav .cat-voyages .nav2 a:hover,
#header-liberation .header-base .nav .cat-voyages .nav2 .on {
    color: #7baf1f
}

#header-liberation .header-base .nav .cat-regions .nav2 a:hover,
#header-liberation .header-base .nav .cat-regions .nav2 .on {
    color: #f2a787
}

#header-liberation .header-base .nav .cat-monlibe .nav2 a:hover,
#header-liberation .header-base .nav .cat-monlibe .nav2 .on {
    color: #fe9900
}

#header-liberation .header-base .nav .cat-zoneabo .nav2 a:hover,
#header-liberation .header-base .nav .cat-zoneabo .nav2 .on {
    color: #a00
}

#header-liberation .header-base .nav .cat-food .nav2 a:hover,
#header-liberation .header-base .nav .cat-food .nav2 .on {
    color: #000
}

#header-liberation .header-simple .header {
    background: url(http://s0.libe.com/libe/img/common/bg-e20000.png?020f61e6035c) repeat-x 0 39px
}
...
#header-liberation .header-annex h1 a {
    color: #000
}
...
#footer-liberation .references ul li a {
    color: #666
}
...
.site-liberation .text-item p.others li a:hover {
    color: #222
}

#core-liberation form input[type=text],
#core-liberation form input[type=password] {
    border-color: #888
}
...
#core-liberation .form-monlibe-unlogged input[type=reset]:hover {
    background: #878787
}
...
#core-liberation .form-monlibe .note-unlogged p.cat-monlibe {
    color: #222
}
...
#core-liberation ul.list-itemsmost li strong {
    color: #e20000
}
...
#core-liberation ul.list-items-mosts li strong {
    color: #e20000
}
...
.site-liberation .block-solid-c2 {
...
.site-liberation .block-solid-c2 h5 a.theme:hover {
    color: #fff
}

.site-liberation .col-contextual .block {
...
.site-liberation .col-contextual .block .block-top a {
    color: #e20000
}

.site-liberation .col-contextual .block .block-bottom {
    border-top-color: #222
}

.site-liberation .col-contextual .block .block-top .right,
.site-liberation .col-contextual .block .block-top .right a {
    color: #7c8280
}

.site-liberation .col-contextual .block .block-top .right a.on {
    color: #222
}

#core-liberation .col-contextual .block-call-items .block-top h5 {
    color: #e20000
}

.site-liberation .col-contextual .block-iframe .block-top>div {
    border-bottom-color: #222
}

.site-liberation .col-contextual .block-nobg {
    background: 0
}

.site-liberation .col-contextual .block-nobg .block-top {
    border-bottom-color: #e20000
}
...
.site-liberation .col-contextual .block-solid-c2 a p {
    color: #c6c6c6
}

.site-liberation .col-part .block {
    background-color: #d7d7d7
}

.site-liberation .col-part .block .block-top {
    color: #fff
}

.site-liberation .col-part .block hr {
    border-top-color: #ccc
}
...
.site-liberation .block-call-items .mini-tpl .whosaid h4 {
    color: #fff
}

.site-liberation .block-call-items .mini-tpl .whosaid h3 a {
    color: #fafafa
}

.site-liberation .block-call-items .mini-tpl .whosaid a {
    color: #2e2e2e
}
...
.site-liberation .block-call-items .tpl-flash-news-29col:last-of-type {
    border-bottom-color: #ddd
}
...
.site-liberation .block-call-items .tpl-spotlight h5 .date {
    color: #555
}

.site-liberation .block-call-items .tpl-labo {
    border-left-color: #b30804
}

.site-liberation .block-call-items .tpl-labo .subscribe p {
    color: #e20000
}
...
.site-liberation .block-call-items .tpl-labo-spotlight .subtitle {
    color: #c6c6c6
}

.site-liberation .block-call-items .tpl-labo-spotlight .subscribe .infos {
    color: #fff
}
...
.site-liberation .block-call-items .tpl-search-results h4,
.site-liberation .block-call-items .tpl-search-results h4 a {
    color: #959595
}
...
.site-liberation .block-item .object-content a:hover {
    color: #e20000
}
...
#core-liberation .block-comments .block-content .comment_post_new a {
    color: #878787
}
...
#core-liberation .block-comments .block-content .meta .who,
#core-liberation .block-comments .block-content .meta .who a {
    color: #878787
}
...
#core-liberation .block-comments .block-content .is_removed>.comment_outer>.meta .who a {
    color: #333
}
...
#core-liberation .block-comments .block-content .comment_reply_links .comment_reply,
#core-liberation .block-comments .block-content .comment_reply_links .comment_reply a {
    color: #fff
}
...
#core-liberation .block-comments .block-content .comment_hover {
    background: #fdfdfd
}

#core-liberation .block-comments .block-content .comment_libe>.comment_outer {
    background: #f8f8f8
}
...
#core-liberation .block-comments .comment_replies_count {
    background: #F8F8F8
}
...
#core-liberation .block-comments .headrest-community h3 a {
    color: #555
}
...
#core-liberation .block-podcast .block-content a {
    color: #666
}
...
#core-liberation .block-label a strong {
    color: #e20000
}

.site-liberation .block-np .block-top h5 .right {
    color: #222
}
...
#core-liberation .block-all-forums .headrest h4 {
    color: #555
}
...
#core-liberation .block-all-blogs .list li .blog-libe h5 {
    background-color: #f5f5f5
}
...
#core-liberation .block-search-results .pagination .current {
    color: #e20000
}
...
#core-liberation .block-search-head p.opinion span {
    color: #707070
}

#core-liberation .block-search-head p.opinion a {
    color: #e20000
}
...
#core-liberation .block-search-head .advanced .note .links,
#core-liberation .block-search-head .advanced .note .links a {
    color: #87888a
}
...
#core-liberation .block-search-head .results p.filters strong {
    color: #2e2e2e
}
...
#core-liberation .block-search-results .block-top h2,
#core-liberation .block-search-results .block-top h2 a {
    color: #e20000
}

#core-liberation .block-search-results .block-content .object-content {
...
#core-liberation .block-search-results .block-content .emission {
    background-color: #f9f9f9
}

#core-liberation .block-search-results .block-content h4,
#core-liberation .block-search-results .block-content h4 a {
    color: #959595
}
...
#core-liberation .headrest-community h3 span {
    color: #fe9900
}
...
#core-liberation .cartridge a.btn-back {
    color: #878787
}
...
#core-liberation .cartridge-basic-rounded p,
#core-liberation .cartridge-basic-rounded p a {
    color: #878787
}

#core-liberation .cartridge-basic-rounded .segment {
    border-left-color: 1px dotted #d4d4d4
}
...
#core-liberation .cartridge-basic-bubble p,
#core-liberation .cartridge-basic-bubble p a {
    color: #878787
}
...
.site-liberation form .btn-zoneabo input[type=reset] {
    color: #fff
}
...
.site-liberation form .btn-laune input[type=submit]:hover {
    background: #3c3c3c
}
...
.site-liberation form .btn-monlibe input[type=reset]:hover {
    background: #3c3c3c
}
...
.site-liberation #core-liberation form .btn-zoneabo input[type=submit] {
    background: #a00
}

.site-liberation #core-liberation form .btn-zoneabo input[type=button]:hover,
.site-liberation #core-liberation form .btn-zoneabo input[type=submit]:hover {
    background: #a00
}
...
.site-liberation .btn-read-digitalpaper {
    border-color: #878787
}

.site-liberation .btn-read-digitalpaper span,
.site-liberation .btn-read-digitalpaper a {
    color: #2e2e2e
}
...
.site-liberation .cat-monlibe .bg-sprites-icons a:hover .folder1 {
    background-position: -131px -84px
}
...
.site-liberation .cat-monlibe .bg-sprites-icons a:hover .close1 {
    background-position: -76px -99px
}
...
.site-liberation .cat-monlibe .bg-sprites-icons a:hover .edit1 {
    background-position: -128px -101px
}
...
.site-liberation .cat-laune .bg-sprites-icons .heart1 {
    background-position: -96px -84px
}

.site-liberation .cat-laune .bg-sprites-icons .on .heart1,
.site-liberation .cat-laune .bg-sprites-icons a:hover .heart1 {
    background-position: -82px -84px
}
...
.site-liberation .toolbox li.spacer span {
    background-color: #d7d7d7
}
...
.site-liberation .toolbox li a span {
    background: url(http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49) no-repeat
}
...
.site-liberation .toolbox li a.print:hover span {
...
.site-liberation .toolbox li a.favorite:hover span {
...
.site-liberation .toolbox li a.comment:hover span {
...
.site-liberation .toolbox li a.mail:hover span {
    background-position: -89px -16px
}

.site-liberation .toolbox li a.facebook span {
    background: url(http://s0.libe.com/libe/img/common/_sprites_icons/icons_share.png?edeb5617b880) no-repeat -74px 0
}

.site-liberation .toolbox li a.twitter span {
    background: url(http://s0.libe.com/libe/img/common/_sprites_icons/icons_share.png?edeb5617b880) no-repeat -74px -14px
}
...
.site-liberation .toolbox li.abo-1-euro a span {
    background: 0
}
...
#bar-liberation .content ul.list li span {
    color: #878787
}
...
#bar-liberation #personal-options-content ul.subscription li.subscribe,
#bar-liberation #personal-options-content ul.subscription li.subscribe a {
    color: #a40000
}
...
#bar-liberation #personal-options-content ul li strong {
    color: #3c3c3c
}

#bar-liberation #personal-options-content ul.inactive li {
    color: #b2b2b2
}
...
#bar-liberation .content .other a span {
    color: #a40000
}
...
#page-mailfriend .content p.note {
    color: #999
}
...
.site-liberation .autopromo-libe1euro a {
    display: block
}

.autopromo-libe1euro .hp span.ft-c {
    text-transform: uppercase
}
...
.site-liberation .autopromo-35unit h2 span {
    display: block
}
...
.site-liberation .autopromo-35unit p+p {
    margin-left: 0
}
...
.site-liberation .autopromo-libe1euro .currency {
    font-size: 40px
}
...
#mainContent #core-liberation .favorites-folders .object-content {
    margin-right: 0
}

#mainContent #core-liberation .favorites-folders .block-content .cartridge {
    width: 210px
}

html.js body.dummy div#mainContent div#core-liberation div.col9 div.block div.block-content div.favorites-folders div.block-call-items div.block-content div.mini-tpl div.folder-on-demand div.object-content {
    min-height: 0
}

html.js body.dummy div#mainContent div#core-liberation div.col9 div.block div.block-content div.favorites-frontpages div.col-left div.cartridge {
    width: 388px
}
...
html.js body.dummy div#mainContent div#core-liberation div.col7 div.block-call-items div.block-content div.mini-tpl div.folder-on-demand {
