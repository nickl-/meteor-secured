...
.saisie {
    /* styles pour input text et autres champs de saisie */
...
.edito_ensemble_lien.resize_mini .double_chevron {
    ...
    /* Fonctionne dÃ©jÃ  sur webkit */
    -webkit-transition-property: transform;
    -webkit-transition-duration: 0.5s;
    -webkit-transition-timing-function: ease-in;

    /* BientÃ´t supportÃ© par Firefox */
    -moz-transition-property: transform;
    -moz-transition-duration: 0.5s;
    -moz-transition-timing-function: ease-in;

    /* â€¦ et lorsque ce sera standardisÃ© */
...
/* filled est ajoutÃ© dynamiquement quand la position contient une publicitÃ© */
...
/* noborder enlÃ¨ve le fond (bordure autour de la pub) */
...
.reaction_identifier .mini-login p {
    /** sur la barre d'outils seulement */
    overflow: hidden;
    clear: both;
}
...
.bloc_part .saisie {
    /* styles pour input text et autres champs de saisie - duplication de base.css */
    background-color: #f8f9fb;
    /*-webkit-box-shadow: inset 3px 3px 3px 5px rgba(250, 250, 250, 0.2), 0 -1px 1px rgba(0, 0, 0, 0.2);
    -moz-box-shadow: inset 3px 3px 3px 5px rgba(250, 250, 250, 0.2), 0 -1px 1px rgba(0, 0, 0, 0.2);
        box-shadow: inset 3px 3px 3px 5px rgba(250, 250, 250, 0.2), 0 -1px 1px rgba(0, 0, 0, 0.2);*/
...
/* grand ecran : live collÃ© Ã  l'extÃ©rieur droit de la page */
...
#nav_ariane.international .ariane>a {
    /*texte onglet couleur la plus claire */
    color: #68b6db;
}
