...
(function () {
    ...
    a.map = i(k), a.mapSeries = j(k), a.reduce = function (b, c, d, e) {
    ...
    a.filter = i(l), a.filterSeries = j(l), a.select = a.filter, a.selectSeries = a.filterSeries;
    ...
    a.reject = i(m), a.rejectSeries = j(m);
    ...
    a.detect = i(n), a.detectSeries = j(n), a.some = function (b, c, d) {
        ...
        var k = function (a) {
            for (var b = 0; b < i.length; b += 1)if (i[b] === a) {
                i.splice(b, 1);
                return
            }
        };
        ...
        j(function () {
            ...
            var i = d.slice(0, Math.abs(d.length - 1)) || [];
            var m = function () {
                return f(i, function (a, b) {
                    return a && h(e, b) !== -1
                }, true)
            };
            if (m())d[d.length - 1](g); else {
                var n = function () {
                    m() && (k(n), d[d.length - 1](g))
                };
                j(n)
            }
        })
    ...
    a.concat = i(o), a.concatSeries = j(o), a.whilst = function (b, c, d) {
        b() ? c(function (e) {
            if (e)return d(e);
            a.whilst(b, c, d)
        }) : d()
        ...
        var d = 0;
        var e = [];
        var f = {concurrency:c, saturated:null, empty:null, drain:null, push:function (b, d) {
            e.push({data:b, callback:d}), f.saturated && e.length == c && f.saturated(), a.nextTick(f.process)
        }, process:function () {
            if (d < f.concurrency && e.length) {
                var a = e.splice(0, 1)[0];
                f.empty && e.length == 0 && f.empty(), d += 1, b(a.data, function () {
                    d -= 1, a.callback && a.callback.apply(a, arguments), f.drain && e.length + d == 0 && f.drain(), f.process()
                })
            }
        }, length:function () {
            return e.length
    ...
    a.log = p("log"), a.dir = p("dir"), a.memoize = function (a, b) {
        var c = {};
        b = b || function (a) {
            return a
        };
        return function () {
            ...
            f in c ? e.apply(null, c[f]) : a.apply(null, d.concat([function () {
                c[f] = arguments, e.apply(null, arguments)
            }]))
        }
    }
})()
