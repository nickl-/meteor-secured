...
function ExtendedHeaderWriter(props) {
    ...
    { path:("PaxHeader" + path.join("/", props.path || ""))
        .replace(/\\/g, "/").substr(0, 100), mode:props.mode || 0666, uid:props.uid || 0, gid:props.gid || 0, size:0 // will be set later
        , mtime:props.mtime || Date.now() / 1000, type:"x", linkpath:"", ustar:"ustar\0", ustarver:"00", uname:props.uname || "", gname:props.gname || "", devmaj:props.devmaj || 0, devmin:props.devmin || 0
    }
...
function encodeFields(fields, prefix, body, nop) {
    ...
    Object.keys(fields).forEach(function (k) {
        ...
        if (val && typeof val === "object" && !Buffer.isBuffer(val)) encodeFields(val, k, body, nop)
