        ...
        [
            ...
            [ 'extendedHeader',
                { path:'PaxHeader/fixtures/Ω.txt',
                    ...
                    devmin:0,
                    fill:'' },
                { path:"fixtures/Ω.txt", "NODETAR.depth":"1", "NODETAR.type":"File", nlink:1, uid:uid, gid:gid, size:2, "NODETAR.blksize":"4096", "NODETAR.blocks":"8" } ]
...
function runTest(t, doGH) {
    var reader = Reader({ path:input, filter:function () {
