...
JS.ENV.Draft75ParserSpec = JS.Test.describe("Draft75Parser", function () {
    with (this) {
        before(function () {
            with (this) {
        ...
        describe("parse", function () {
            with (this) {
                sharedBehavior("draft-75 parser", function () {
                    with (this) {
                        it("parses text frames", function () {
                            with (this) {
                        ...
                        it("parses text frames beginning 0x00-0x7F", function () {
                            with (this) {
                                expect(webSocket, "receive").given("Hello")
                        ...
                        it("ignores frames with a length header", function () {
                            with (this) {
                        ...
                        it("parses text following an ignored block", function () {
                            with (this) {
                                expect(webSocket, "receive").given("Hello")
                        ...
                        it("parses multibyte text frames", function () {
                            with (this) {
                        ...
                        it("parses fragmented frames", function () {
                            with (this) {
                                expect(webSocket, "receive").given("Hello")
                ...
                it("does not close the socket if a 76 close frame is received", function () {
                    with (this) {
