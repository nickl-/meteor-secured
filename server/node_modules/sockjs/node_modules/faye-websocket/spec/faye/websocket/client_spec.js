...
JS.ENV.ClientSpec = JS.Test.describe("Client", function () {
    with (this) {
        ...
        sharedBehavior("socket client", function () {
            with (this) {
                ...
                it("cannot open a connection to the wrong host", function () {
                    with (this) {
                ...
                it("cannot open a connection with unacceptable protocols", function () {
                    with (this) {
                ...
                it("can close the connection", function () {
                    with (this) {
                        open_socket(socket_url, protocols)
                        close_socket()
                        check_closed()
                ...
                describe("in the OPEN state", function () {
                    with (this) {
                        before(function () {
                            with (this) {
                                open_socket(socket_url, protocols)
                ...
                describe("in the CLOSED state", function () {
                    with (this) {
                        before(function () {
                            with (this) {
                                open_socket(socket_url, protocols)
                        ...
                        it("cannot send and receive messages", function () {
                            with (this) {
                                listen_for_message()
                                send_message()
                                check_no_response()
        ...
        describe("with a plain-text server", function () {
            with (this) {
                before(function () {
        ...
        describe("with a secure server", function () {
            with (this) {
                before(function () {
