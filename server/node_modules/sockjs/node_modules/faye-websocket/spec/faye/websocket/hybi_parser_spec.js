...
JS.ENV.HybiParserSpec = JS.Test.describe("HybiParser", function () {
    with (this) {
        before(function () {
            with (this) {
        ...
        describe("parse", function () {
            with (this) {
                define("mask", function () {
                    return this._mask = this._mask || [1, 2, 3, 4].map(function () {
                ...
                it("parses unmasked text frames", function () {
                    with (this) {
                ...
                it("parses multiple frames from the same packet", function () {
                    with (this) {
                ...
                it("parses empty text frames", function () {
                    with (this) {
                ...
                it("parses fragmented text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("Hello")
                ...
                it("parses masked text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("Hello")
                ...
                it("parses masked empty text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("")
                ...
                it("parses masked fragmented text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("Hello")
                ...
                it("closes the socket if the frame has an unrecognized opcode", function () {
                    with (this) {
                ...
                it("closes the socket if a close frame is received", function () {
                    with (this) {
                ...
                it("parses unmasked multibyte text frames", function () {
                    with (this) {
                ...
                it("parses frames received in several packets", function () {
                    with (this) {
                        expect(webSocket, "receive").given("Apple = ")
                ...
                it("parses fragmented multibyte text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("Apple = ")
                ...
                it("parses masked multibyte text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("Apple = ")
                ...
                it("parses masked fragmented multibyte text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("Apple = ")
                ...
                it("parses unmasked medium-length text frames", function () {
                    with (this) {
                ...
                it("parses masked medium-length text frames", function () {
                    with (this) {
                        expect(webSocket, "receive").given("HelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHelloHello")
                ...
                it("replies to pings with a pong", function () {
                    with (this) {
        ...
        describe("frame", function () {
            with (this) {
                it("returns the given string formatted as a WebSocket frame", function () {
                    with (this) {
                        assertBufferEqual([0x81, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f], parser.frame("Hello"))
                    }
                })

                it("encodes multibyte characters correctly", function () {
                    with (this) {
                        assertBufferEqual([0x81, 0x0b, 0x41, 0x70, 0x70, 0x6c, 0x65, 0x20, 0x3d, 0x20, 0xef, 0xa3, 0xbf], parser.frame("Apple = "))
                    }
                })

                it("encodes medium-length strings using extra length bytes", function () {
                    with (this) {
                ...
                it("encodes long strings using extra length bytes", function () {
                    with (this) {
