...
function ParserTestSuite(callback) {
    var inps = [
        ...
        ['hi; // moo\n;', 'single line comment'],
        ['var varwithfunction;', 'Dont match keywords as substrings'],
        // difference between `var withsomevar` and `"str"` (local search and lits)
        ['a + b;', 'addition'],
        ...
        ['var o = {"b":2};', 'object literal quoted key'],
        // opening curly may not be at the start of a statement...
