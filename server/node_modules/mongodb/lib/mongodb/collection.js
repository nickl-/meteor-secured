...
Collection.prototype.distinct = function distinct(key, query, options, callback) {
    ...
    var mapCommandHash = {
        'distinct':this.collectionName, 'query':query, 'key':key
    };
...
Collection.prototype.count = function count(query, options, callback) {
    ...
    // Final query
    var final_query = {
        'count':this.collectionName, 'query':query, 'fields':null
    };
...
Collection.prototype.findAndModify = function findAndModify(query, sort, doc, options, callback) {
    ...
    var queryObject = {
        'findandmodify':this.collectionName, 'query':query, 'sort':utils.formattedOrderClause(sort)
    };
...
Collection.prototype.mapReduce = function mapReduce(map, reduce, options, callback) {
    ...
    var mapCommandHash = {
        mapreduce:this.collectionName, map:map, reduce:reduce
    };
...
Collection.prototype.group = function group(keys, condition, initial, reduce, finalize, command, options, callback) {
    ...
    if (command) {
        ...
        var selector = {
            group:{
                'ns':this.collectionName, '$reduce':reduceFunction, 'cond':condition, 'initial':initial, 'out':"inline"
            }
        };
