...
var r = fstream.Reader({ path:path.dirname(__dirname), filter:function () {
...
var w = fstream.Writer({ path:path.resolve(__dirname, "filter-copy"), type:"Directory", filter:function () {
