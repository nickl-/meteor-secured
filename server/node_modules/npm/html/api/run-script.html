...
<body>
<div id="wrapper">
  <h1><a href="../api/run-script.html">run-script</a></h1>
  ...
  <ul>
    ...
    <li><a href="../api/test.html">test(3)</a></li>
    <li><a href="../api/start.html">start(3)</a></li>
    <li><a href="../api/restart.html">restart(3)</a></li>
    <li><a href="../api/stop.html">stop(3)</a></li>
  </ul>
</div>
