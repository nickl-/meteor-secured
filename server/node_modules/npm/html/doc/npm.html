...
<body>
<div id="wrapper">
  <h1><a href="../doc/npm.html">npm</a></h1>
  ...
  <ul>
    <li>global mode:<br/>npm installs packages into the install prefix at
      <code>prefix/lib/node_modules</code> and bins are installed in <code>prefix/bin</code>.
    </li>
    <li>local mode:<br/>npm installs packages into the current project directory, which
      defaults to the current working directory. Packages are installed to
      <code>./node_modules</code>, and bins are installed to <code>./node_modules/.bin</code>.
    </li>
  </ul>
  ...
  <ul>
    <li>json:
      Make a package.json file. See <code><a href="../doc/json.html">json(1)</a></code>.
    </li>
    <li>link:
      For linking your current working code into Node&#39;s path, so that you
      don&#39;t have to reinstall every time you make a change. Use
      <code>npm link</code> to do this.
    </li>
    <li>install:
    ...
    <li>publish:
      Use the <code>npm publish</code> command to upload your code to the registry.
    </li>
  </ul>
  ...
  <ul>
    <li><a href="http://github.com/isaacs/npm/issues">http://github.com/isaacs/npm/issues</a></li>
  ...
  <ul>
    <li>web:
      <a href="http://github.com/isaacs/npm/issues">http://github.com/isaacs/npm/issues</a></li>
    <li>email:
  ...
  <ul>
    ...
    <li><a href="../doc/index.html">index(1)</a></li>
