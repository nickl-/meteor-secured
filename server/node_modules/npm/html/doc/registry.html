...
<body>
<div id="wrapper">
  <h1><a href="../doc/registry.html">registry</a></h1>
  ...
  <p>The official public npm registry is at <a href="http://registry.npmjs.org/">http://registry.npmjs.org/</a>. It
    ...
    <a href="http://isaacs.iriscouch.com/registry">http://isaacs.iriscouch.com/registry</a>. The code for the couchapp
    is
  ...
  <h2 id="I-don-t-want-my-package-published-in-the-official-registry-It-s-private">I don&#39;t want my package published
    in the official registry. It&#39;s private.</h2>
  ...
  <h2 id="Will-you-replicate-from-my-registry-into-the-public-one">Will you replicate from my registry into the public
    one?</h2>
  ...
  <h2 id="Do-I-have-to-use-couchdb-to-build-a-registry-that-npm-can-talk-to">Do I have to use couchdb to build a
    registry that npm can talk to?</h2>

  <p>No, but it&#39;s way easier.</p>

  <h2 id="I-published-something-elsewhere-and-want-to-tell-the-npm-registry-about-it">I published something elsewhere,
    and want to tell the npm registry about it.</h2>
...
<pre><code>PUT /my-foreign-package
  ...
  <h2 id="Is-there-a-website-or-something-to-see-package-docs-and-such">Is there a website or something to see package
    docs and such?</h2>
  ...
  <ul>
    ...
    <li><a href="../doc/disputes.html">disputes(1)</a></li>
  </ul>
</div>
