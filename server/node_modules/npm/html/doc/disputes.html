...
<body>
<div id="wrapper">
  <h1><a href="../doc/disputes.html">disputes</a></h1>
  ...
  <ol>
    ...
    <li>Email the author, CC <a href="mailto:i@izs.me">i@izs.me</a>.</li>
  ...
  <ol>
    <li>Bob writes a JavaScript module <code>foo</code>, which is not node-specific.
    ...
    <li>Bob writes a 10-line flow-control library, and calls it <code>foo</code>, and
      ...
      routinely confused when <code>npm install foo</code> is some different thing.
    </li>
    <li>Bob writes a parser for the widely-known <code>foo</code> file format, because
      ...
      but can&#39;t publish, because Bob&#39;s <code>foo</code> is in the way.
    </li>
  </ol>
  ...
  <ol>
    ...
    <li>Joe emails Bob, explaining the situation <strong>as respectfully as possible</strong>,
      ...
      the <code>foo</code> package.
    </li>
    <li>After a reasonable amount of time, if Bob has not responded, or if
      Bob and Joe can&#39;t come to any sort of resolution, email isaacs
      <a href="mailto:i@izs.me">i@izs.me</a> and we&#39;ll sort it out.
    </li>
  </ol>
  ...
  <ol>
    <li>Malware (that is, a module designed to exploit or harm the machine on
  ...
  <ul>
    ...
    <li><a href="../doc/owner.html">owner(1)</a></li>
  </ul>
</div>
