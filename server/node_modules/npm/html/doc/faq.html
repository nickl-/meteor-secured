...
<body>
<div id="wrapper">
<h1><a href="../doc/faq.html">faq</a></h1>
...
<ul>
  ...
  <li>Global installs are different from local installs. If you install
    ...
    and its modules go in <code>npm root -g</code>.
  </li>
</ul>

<h2 id="How-do-I-install-something-on-my-computer-in-a-central-location">How do I install something on my computer in a
  central location?</h2>
...
<h2 id="I-installed-something-globally-but-I-can-t-require-it">I installed something globally, but I can&#39;t <code>require()</code>
  it</h2>
...
<h2 id="Why-can-t-npm-just-put-everything-in-one-place-like-other-package-managers">Why can&#39;t npm just put
  everything in one place, like other package managers?</h2>
...
<h2 id="Whatever-I-really-want-the-old-style-everything-global-style">Whatever, I really want the old style &#39;everything
  global&#39; style.</h2>
...
<h2 id="Should-I-check-my-node_modules-folder-into-git">Should I check my <code>node_modules</code> folder into git?
</h2>

<p>Mikeal Rogers answered this question very well:</p>

<p><a href="http://www.mikealrogers.com/posts/nodemodules-in-git.html">http://www.mikealrogers.com/posts/nodemodules-in-git.html</a>
</p>
...
<h2 id="If-npm-is-an-acronym-why-is-it-never-capitalized">If &#39;npm&#39; is an acronym, why is it never
  capitalized?</h2>
...
<p>In software, &quot;NPM&quot; is a Non-Parametric Mapping utility written by
  ...
  about the (capitalized) NPM program at <a
          href="http://www.cabiatl.com/mricro/npm/">http://www.cabiatl.com/mricro/npm/</a>.</p>
...
<ul>
  <li><a href="https://github.com/isaacs/nave">https://github.com/isaacs/nave</a></li>
...
<p>See <code><a href="../doc/developers.html">developers(1)</a></code> and <code><a href="../doc/json.html">json(1)</a></code>.
</p>
...
<h2 id="How-do-I-symlink-to-a-dev-folder-so-I-don-t-have-to-keep-re-installing">How do I symlink to a dev folder so I
  don&#39;t have to keep re-installing?</h2>
...
<h2 id="I-forgot-my-password-and-can-t-publish-How-do-I-reset-it">I forgot my password, and can&#39;t publish. How do I
  reset it?</h2>
...
<p>Please see this discussion: <a href="https://github.com/isaacs/npm/issues/798">https://github.com/isaacs/npm/issues/798</a>
</p>
...
<h2 id="I-have-a-question-or-request-not-addressed-here-Where-should-I-put-it">I have a question or request not
  addressed here. Where should I put it?</h2>

<p>Discuss it on the mailing list, or post an issue.</p>

<ul>
  <li><a href="mailto:npm-@googlegroups.com">npm-@googlegroups.com</a></li>
  <li><a href="https://github.com/isaacs/npm/issues">https://github.com/isaacs/npm/issues</a></li>
</ul>
...
<ul>
  <li><a href="../doc/npm.html">npm(1)</a></li>
  <li><a href="../doc/developers.html">developers(1)</a></li>
  <li><a href="../doc/json.html">json(1)</a></li>
  <li><a href="../doc/config.html">config(1)</a></li>
  <li><a href="../doc/folders.html">folders(1)</a></li>
</ul>
</div>
