...
<body>
<div id="wrapper">
  <h1><a href="../doc/edit.html">edit</a></h1>
  ...
  <p>Opens the package folder in the default editor (or whatever you&#39;ve
    configured as the npm <code>editor</code> config -- see <code><a href="../doc/config.html">config(1)</a></code>.)
  </p>
  ...
  <ul>
    ...
    <li><a href="../doc/explore.html">explore(1)</a></li>
