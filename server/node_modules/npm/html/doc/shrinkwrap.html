...
<body>
<div id="wrapper">
  <h1><a href="../doc/shrinkwrap.html">shrinkwrap</a></h1>
...
<pre><code>{
  ...
  <ol>
    <li>Run &quot;npm install&quot; in the package root to install the current versions of all
      dependencies.
    </li>
    <li>Validate that the package works as expected with these versions.</li>
    <li>Run &quot;npm shrinkwrap&quot;, add npm-shrinkwrap.json to git, and publish your
      package.
    </li>
  </ol>
  ...
  <ol>
    ...
    <li>Add or update dependencies. &quot;npm install&quot; each new or updated package
    ...
    <li>Run &quot;npm shrinkwrap&quot;, commit the new npm-shrinkwrap.json, and publish your
      package.
    </li>
  </ol>
  ...
  <ul>
    ...
    <li><a href="../doc/list.html">list(1)</a></li>
  </ul>
</div>
