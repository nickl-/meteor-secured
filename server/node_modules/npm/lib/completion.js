...
function completion(args, cb) {
    ...
    var opts = { words:words, w:w, word:word, line:line, lineLength:line.length, point:point, partialLine:partialLine, partialWords:partialWords, partialWord:partialWord, raw:args
    }
...
function dumpScript(cb) {
    ...
    fs.readFile(p, "utf8", function (er, d) {
        ...
        process.stdout.write(d, function (n) {
            cb()
        })
