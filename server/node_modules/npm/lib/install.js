    ...
    mkdir(where, function (er, made) {
        ...
        if (!args.length) {
            ...
            if (npm.config.get("global")) args = ["."]
                ...
                var context = { family:{}, ancestors:{}, explicit:false, parent:data, wrap:null }
        ...
        readJson(path.resolve(where, "package.json"), function (er, data) {
            ...
            if (er) data = null
            var context = { family:{}, ancestors:{}, explicit:true, parent:data, wrap:null }
            if (data) {
...
function save(where, installed, tree, pretty, cb) {
    if (!npm.config.get("save") && !npm.config.get("save-dev") && !npm.config.get("save-optional") ||
...
function prettify(tree, installed) {
    ...
    return Object.keys(tree).map(function (p) {
        return archy({ label:tree[p].what + " " + p, nodes:(tree[p].children || []).map(function P(c) {
...
function treeify(installed) {
    ...
    var whatWhere = installed.reduce(function (l, r) {
        var parentDir = r[3]
            ...
            , what = r[0]
            , from = r[4]
        l[where] = { parentDir:parentDir, parent:parent, children:[], where:where, what:what, from:from }
        return l
    }, {})
        ...
        asyncMap(what
            ...
            , function (er, targets) {
                ...
                asyncMap(targets, function (target, cb) {
                    ...
                    var newContext = { family:newPrev, ancestors:newAnc, parent:parent, explicit:false, wrap:newWrap }
...
function targetResolver(where, context, deps) {
    ...
    return function resolver(what, cb) {
        ...
        cache.add(what, function (er, data) {
            ...
            if (!er &&
                data && !context.explicit &&
                context.family[data.name] === data.version && !npm.config.get("force")) {
        ...
        ([
            ...
            , function X(er) {
                ...
                readDependencies(context, targetFolder, opt, function (er, data, wrap) {
                    ...
                    var depsContext = { family:family, ancestors:context.ancestors, parent:target, explicit:false, wrap:wrap }
