...
var files = {
    kb:'http://www.browserscope.org/?category=jskb&v=%accuracy%&o=json', modernizer:'http://www.browserscope.org/?category=usertest_agt1YS1wcm9maWxlcnINCxIEVGVzdBib2KQGDA&v=%accuracy%&o=json'
}

module.exports = function update(keys, x, fn) {
    var accuracy = {
        major:1, minor:2, all:3
    };
