...
div.browse {
  ...
  div.header {
    ...
    text-align: left;
    background: @bg url('/images/panel_header_bg.png') repeat-x top left;
    border-bottom: 1px solid (@bg * 0.66 + @black * 0.33);
    line-height: 1;
    height: 18px;
    .border_radius_top(3);
    color: @light_grey;
    h3 {
      font-size: 16px;
      margin: 0;
      color: @white; .text_shadow(1, 1, 0, @bg * 0.66 + @black * 0.33);
    }
    span.filter {
      float: left;
      display: block;
      ...
      a {
        ...
        :last-child { .border_radius_right(2);
          margin-right: 0;
        }
      }
    }
    ...
    span.filter.dropdown {
      ...
      ul {
        ...
        margin: 1px 0 0;
        padding: 0;
        background: @white; .border_radius(2);
        ...
        li {
          ...
          a {
            ...
            border-bottom: 1px solid (@light_grey * 0.66 + @white * 0.33);
            float: none;
            margin: 0; .border_radius(0);
            white-space: nowrap;
            :hover {
    ...
    span.filter.dropdown.sort {
      float: left;
      margin: 0 0 0 10px;
    }
    span.filter.dropdown.localisation {
      float: left;
      margin: 0 0 0 10px;
    }
    a.more {
  ...
  > ul {
    margin: 0;
    background: @white;
    padding: 10px 0 0 10px; .border_radius(3);
    position: relative;
    li {
      display: block;
      float: left;
      ...
      background: @white;
      width: 130px;
      border: 1px solid (@light_grey * 0.33 + @white * 0.66); .border_radius(2);
      a.remove {
        position: absolute;
        height: 16px;
        width: 16px;
      ...
      div.thumbnail {
        ...
        .marker.coupon {
          ...
          b {
            ...
            border-top: 14px solid @accent_colour;
            border-bottom: none;
            border-right: none;
            float: left;
          }
          span {
            ...
            display: block;
            padding: 0 4px 0 2px;
            background: @accent_colour; .text_shadow(1, 1, 0px, (@accent_colour * 0.75 + @black * 0.25));
            margin: 0 0 0 14px;
          }
        }
        .marker.video {
        ...
        .marker.endorsed_by_me {
          background: none;
          padding: 0;
          right: 0;
          bottom: -32px; .border_radius(2);
          background: @white;
        }
        a.thumbnail {
          display: block;
      ...
      div.text {
        ...
        a.title {
          ...
          :before {
            ...
            background: @white;
            position: relative;
            z-index: 1; .box_shadow(-5, 0, 10, @white);
          }
        }
        small {
          font-size: 11px;
      ...
      :hover {
        ...
        div.text {
          ...
          a.title:before {
            background: @accent_colour; .box_shadow(-5, 0, 10, @accent_colour);
          }
          small {
    ...
    li.paginate {
      ...
      a {
        ...
        div.arrow {
          ...
          border: 1px solid (@accent_colour * 0.75 + @black * 0.25);
          height: 44px; .border_radius(99);
          width: 44px;
          margin: 0 auto;
          position: relative;
          top: 32px;
        ...
        div.label {
          ...
          right: 0;
          line-height: 13px;
          color: @accent_colour * 0.85 + @black * 0.15;
          text-decoration: none;
          font-weight: bold;
          font-size: 12px;
          text-align: center;
    ...
    li.paginate.previous a div b {
      border-right: 15px solid @white;
      border-left: none;
      left: 12px;
    }
    li.paginate.next a div b {
  ...
  > ul {
    ...
    > li {
      ...
      span.marker.new {
        ...
        top: -5px;
        background: none;
        background-color: @white * 0.1 + @yellow * 0.6 + @red * 0.3;
        line-height: 1;
        padding: 2px 5px;
        font-weight: bold;
      }
  ...
  ul {
    ...
    li {
      ...
      a {
        ...
        text-decoration: none; .border_radius_left(3);
      }
      a:hover {
        color: @black;
...
#ad {
  ...
  div.footer {
    ...
    div.vote_views {
      ...
      #login_register_msg, #encourage_vote_msg {
        line-height: 22px;
        font-weight: bold;
        color: @black;
      }
...
div.voted {
  ...
  img {
    float: left;
    margin-right: 5px;
    padding: 3px; .border_radius(3);
  }
}

#voted_up {
  img {
    background: @colour_positive * 0.66 + @bg * 0.15;
  }
}

#voted_down {
  img {
    background: @colour_negative * 0.66 + @bg * 0.15;
  }
}
...
#vote {
  ...
  a.up {
    float: left;
    background: @colour_positive * 0.66 + @bg * 0.15; .border_radius_left(3);
    :hover {
      background: @colour_positive * 0.85 + @bg * 0.15;
    }
  }
  a.down {
    float: left;
    background: @colour_negative * 0.66 + @bg * 0.15; .border_radius_right(3);
    margin: 0 5px 0 1px;
    :hover {
      background: @colour_negative * 0.85 + @bg * 0.15;
    }
  }
}
...
#vote.disabled {
  a.up {
    ...
    :hover {
      background: (@colour_positive * 0.85 + @bg * 0.15) * 0.25 + @grey * 0.75;
    }
  }
  a.down {
    background: (@colour_negative * 0.66 + @bg * 0.15) * 0.15 + @grey * 0.85;
    :hover {
      background: (@colour_negative * 0.85 + @bg * 0.15) * 0.25 + @grey * 0.75;
    }
  }
}
...
div.panel {
  margin: 0 0 20px;
  position: relative; .box_shadow(0, 0, 3, @light_grey * 0.66 + @white * 0.33); .border_radius(3);
  > div.header {
    background: @bg url('/images/panel_header_bg.png') repeat-x top left;
    border-bottom: 1px solid (@bg * 0.66 + @black * 0.33);
    padding: 5px 10px 4px; .border_radius_top(3);
    min-height: 18px;
    h2 {
      font-size: 16px;
      margin: 0;
    ...
    h3 {
      ...
      font-size: 14px;
      margin: 0;
      line-height: 18px; .text_shadow(1, 1, 0, @bg * 0.66 + @black * 0.33);
    }
    small {
      display: block;
      font-size: 12px;
      color: @light_grey * 0.25 + @white * 0.75;
    }
    span.filter {
      float: left;
      display: block;
      ...
      a:last-child { .border_radius_right(2);
        margin-right: 0;
      }
      a.active {
        background: @white;
  ...
  > div.footer {
    background: @light_grey * 0.33 + @white * 0.66;
    border-top: 1px solid (@light_grey * 0.5 + @white * 0.5);
...
div.panel.collapsed {
  ...
  div.blank {
    border-bottom: none; .border_radius_bottom(3);
  }
  ...
  #actions {
    ...
    div.content {
      ...
      div.blank {
        ...
        background: none;
        padding: 10px 0 0;
        border-top: 1px solid (@accent_colour * 0.5 + @white * 0.5);
        margin: 10px 0 0;
      }
    }
  }
...
ul.people {
  ...
  > li {
    ...
    background: @white;
    list-style: none;
    border: 1px solid (@light_grey * 0.33 + @white * 0.66);
    a.avatar {
      display: block;
      width: 59px;
      height: 59px;
...
ul.people.tiled {
  > li {
    ...
    a.name, small, span.networks, span.points {
      display: none;
    }
  }
}
  ...
  #account_nav {
    ...
    ul.nav {
      ...
      li {
        ...
        :hover {
          a {
            ...
            span {
              background: @bg; .border_radius_right(0);
            }
          }
        }
      }
      li.current a {
        ...
        span {
          background: @accent_colour;
          color: @white; .border_radius_right(0);
        }
      }
    }
  }
    ...
    #networks {
      ul {
        ...
        li:hover {
          ...
          padding: 10px;
          margin: 0 10px 10px 0;
          list-style: none; .border_radius(3);
          position: relative;
          * {
            line-height: normal;
          }
...
div.blank {
  padding: 20px;
  background: @bg * 0.05 + @blue * 0.05 + @white * 0.9;
  position: relative;
  border: 1px solid (@bg * 0.1 + @blue * 0.1 + @white * 0.8);
  z-index: 1;
  h4 {
    font-size: 18px;
    margin: 0 0 10px;
  ...
  a.hide {
    ...
    width: 16px;
    padding: 3px;
    background: #E7E9F6; .border_radius(99);
  }
}
...
div.blank.with_border_bottom {
  border-bottom: 1px solid (@bg * 0.1 + @blue * 0.1 + @white * 0.8);
}
...
label.list_number.large {
  padding: 4px;
  width: 48px;
  height: 48px; .border_radius(99);
  position: relative;
  left: -10px;
  b {
    font-size: 28px;
    height: 40px;
    width: 40px; .border_radius(99);
    line-height: 40px;
    .text_shadow(2, 2, 0px, (@accent_colour * 0.75 + @black * 0.25));
    border-width: 4px;
  }
}
    ...
    #influences {
      ...
      div.tab_content {
        ...
        > ul {
          ...
          max-height: 280px;
          min-height: 120px;
          overflow-y: scroll; .border_radius_bottom(3px);
        }
      }
      div.footer {
        form {
...
#pages_controller.faq {
  #answers {
    h3 {
      margin-top: 20px;
      padding-top: 20px;
      border-top: 1px solid (@light_grey * 0.75 + @white * 0.25);
    }
    h3.first {
      margin-top: 0;
      padding-top: 0;
...
#person_overview {
  ...
  #person {
    ...
    > div {
      margin: 0 0 0 75px;
      color: @white;
      font-size: 14px; .text_shadow(1, 1, 0, @bg * 0.66 + @black * 0.33);
    }
    div.name {
      h2 {
        margin: 0 0 5px;
        ...
        a {
          font-size: 20px;
          font-weight: bold; .text_shadow(1, 1, 0, @bg * 0.66 + @black * 0.33);
          line-height: 1;
          color: @white;
          text-decoration: none;
          :hover {
      ...
      span.points {
        float: right;
        display: block;
        padding: 5px 10px; .border_radius(2);
        text-align: center;
        background: @white;
        position: relative;
        min-width: 45px;
        strong {
          ...
          font-size: 24px;
          line-height: 1;
          display: block; .text_shadow(0, 0, 0, transparent);
        }
        label {
          font-size: 9px;
          text-transform: uppercase;
      ...
      span.points.with_redeem {
        ...
        a.button {
          display: block;
          text-align: center; .border_radius_top(0);
          font-size: 10px;
          font-weight: bold;
          padding: 0;
          position: absolute;
    ...
    div.extra {
      ...
      #less_info {
        span.toggle {
          b.arrow {
            border-top: 5px solid @accent_colour;
            border-bottom: 0;
          }
        }
      }
      #more_info {
        span.toggle {
          float: right;
          b.arrow {
            border-bottom: 5px solid @accent_colour;
            border-top: 0;
          }
        }
        h4 {
          color: @white;
          margin: 0 0 10px 0;
          border-bottom: 1px solid (@white * 0.25 + @bg * 0.75); .text_shadow(1, 1, 0, @bg * 0.66 + @black * 0.33);
          span {
            font-size: 12px;
          }
        }
...
#dashboard_nav {
  ...
  li {
    ...
    a {
      ...
      height: 28px;
      padding: 0 10px;
      line-height: 28px; .border_radius_top(2);
      text-decoration: none;
      color: @white;
...
#dwellometer {
  z-index: 45;
  float: right; .box_shadow(0, 0, 0, transparent);
  margin: 0;
  div.content {
    text-align: center;
    position: relative;
    ...
    ul.events {
      ...
      li {
        ...
        div.symbols {
          ...
          b.voted.for {
            background: @colour_positive * 0.33 + @white * 0.66;
          }
          b.voted.against {
            background: @colour_negative * 0.33 + @white * 0.66;
          }
        }
      ...
      /*        div.symbols a.agent, b { display: none; }*/
        ...
        div.comment {
          ...
          b.tail {
            ...
            border: 5px solid transparent;
            border-top: none;
            border-bottom: 5px solid (@light_grey * 0.25 + @white * 0.75);
          }
          blockquote {
            margin: 0;
            font-style: normal;
      ...
      li.voted div.description span.action { .border_radius(2);
        color: @dark_grey;
        padding: 0 3px;
        white-space: nowrap;
      }
      li.voted.for div.description span.action {
        background: @colour_positive * 0.15 + @white * 0.85;
      }
      li.voted.against div.description span.action {
        background: @colour_negative * 0.15 + @white * 0.85;
      }
      li:first-child {
        padding-top: 0;
      }
...
/* lost comment */
  ...
  border: 1px solid black; // padding & margin //
  padding: 0;
  margin: 2em;
}
...
.more-parens {
  ...
  width: (@var * @var) * 6;
  height: (7 * 7) + (8 * 8);
  margin: 4 * (5 + 5) / 2 - (@var * 2); //margin: (6 * 6)px;
}
